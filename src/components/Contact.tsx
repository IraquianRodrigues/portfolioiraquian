            ...
            <div className="container-custom">
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-4">
                            {contactInfo.map((info, index) => (
                                <motion.a
                                    ...
                                    viewport={{ once: true }}
                                    className="flex items-center p-4 bg-white dark:bg-neutral-900 rounded-lg shadow-lg hover:shadow-xl transition-shadow border border-orange-100 dark:border-neutral-800"
                                >
                                    <div className="p-3 bg-orange-100 dark:bg-orange-900/30 rounded-lg mr-4">
                                        <info.icon className="text-orange-600 dark:text-orange-400" size={24} />
                                    </div>
                                    <div>
                        ...
                        <div>
                            ...
                            <div className="flex space-x-4">
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.9 }}
                                    className="p-3 bg-orange-100 dark:bg-neutral-900 rounded-full hover:bg-orange-200 dark:hover:bg-neutral-800 transition-colors"
                                >
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                        viewport={{ once: true }}
                        className="bg-white dark:bg-neutral-900 rounded-xl p-8 shadow-lg border border-orange-100 dark:border-neutral-800"
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={6}
                                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-none"
